...
const FeaturedApp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-8 bg-gray-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-[110rem] p-4 sm:p-8">
        <div className="bg-[#FFF6E2E5] shadow-md rounded-lg p-8 hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-95 hover:translate-y-1 flex flex-col w-full">
          <div className="flex bg-white rounded w-44 space-x-4 h-12 items-center px-4 mb-6">
            <img
        ...
        <div className="bg-[#EDFFF2E5] shadow-md rounded-lg p-8 hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-95 hover:translate-y-1 flex flex-col w-full">
          <div className="flex bg-white rounded w-44 h-12 items-center px-4 mb-6 space-x-4">
            <img
              src="/symbol.2d89ec5c.svg"
              alt="AU PAY logo"
              className="w-8 h-8"
        ...
        <div className="bg-[#DFF3FFAB] shadow-md rounded-lg p-8 hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-95 hover:translate-y-1 flex flex-col w-full">
          <div className="flex bg-white rounded w-44 space-x-4 h-12 px-4 mb-6 items-center">
            <img
              src="/symbol.2d89ec5c.svg"
              alt="AU SHOP logo"
              className="w-8 h-8"
