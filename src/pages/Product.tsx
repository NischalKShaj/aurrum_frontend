    ...
    <div>
      <div className="relative">
        ...
        <div className="text-center flex flex-row items-center justify-center gap-6">
          ...
          <div className="flex flex-col items-start max-w-full text-left">
            <h2 className="text-6xl font-semibold text-yellow-500 mb-4 break-words">
              The Hybrid ERP Magic
            </h2>
            <p className="text-3xl font-semibold text-gray-700 break-words max-w-[500px]">
              Inventory Management Excellence In Every Tap
            </p>
            <p className="text-lg mt-2 text-gray-700 break-words max-w-[700px]">
